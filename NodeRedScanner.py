...
run_command = True  # While true 'command_to_run' will execute on all servers vulnerable. When false, vulnerable URLs will just be printed to terminal.
...
for item in data:
    ...
    if check_url_for_vulnerability(ip, port, path) and run_command:
